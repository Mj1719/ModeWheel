...
const MODE_FAMILIES = {
  ...
  "Harmonic Minor": {
    ...
    names: [
      ...
      "Lydian Dominant b3","Phrygian Dominant","Lydian +2","Altered o7"
    ],
    sets: [
      [0,2,3,5,7,8,11],
      [0,1,3,5,6,9,10],
  ...
  "Harmonic Major": {
    ...
    names: [
      ...
      "Lydian b3","Mixolydian b2","Lydian Augmented +2","Locrian o7"
    ],
    sets: [
      [0,2,4,5,7,8,11],
      [0,2,3,5,6,9,10],
  ...
  "Lydian b2": {
    ...
    noteCount: 7,
    names: [
      "Harmonic Locrian","Mode 2","Mode 3",
      "Mode 4","Mode 5","Mode 6", "Mode 7"
    ],
    sets: [
      [0,1,4,6,7,9,11],
