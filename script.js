...
const MODE_FAMILIES = {
  ...
  "Ionian b5 b6": {
    familyIndex: 14, // -11 / +11
    noteCount: 7,
    names: ["Ionian b5 b6","Mode 2","Mode 3","Lydian b2 b3","Mode 5","Mode 6","Mode 7"],
    sets: [
      [0,2,4,5,6,8,11], // 0
      [0,2,3,4,6,9,10], // -2
      [0,1,2,4,7,8,10], // -4
  ...
  "Lydian Augmented b2": {
    familyIndex: 16, // -11 / +11
    noteCount: 7,
    names: ["Melodic Minor b4","Mode 2","Lydian Augmented b2","Mode 4","Mode 5","Mode 6","Mode 7"],
    sets: [
      [0,2,3,4,7,9,11], // 0
      [0,1,2,5,7,9,10], // -2
      [0,1,4,6,8,9,11], // +3
  ...
  "Enigmatic": {
    ...
    sets: [
      ...
      [0,2,3,4,6,9,11], // -1
      [0,1,2,4,7,9,10], // -3
      [0,1,3,6,8,9,11] // -5 (flattest)
    ]
  },

  "Heptatonic 66": {
    familyIndex: 66, // -31 / +31
    noteCount: 7,
    names: ["Mode 1","Mode 2","Mode 3","Mode 4","Mode 5","Mode 6","Mode 7"],
    sets: [
      [0,6,7,8,9,10,11], // +15
